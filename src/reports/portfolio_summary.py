...
def build_kpi_table(company):
    ...
    data = [
        ...
        [
            "Debt / Equity",
            format_value(company["debt_to_equity"])
        ],

        [
            "Quality Score",
            format_value(company["composite_quality_score"])
        ],

        [
            "Book Value",
            format_value(company["book_value"])
        ],

        [
            "Face Value",
            format_value(company["face_value"])
        ]
...
def main():
    ...
    portfolio["roe_percentage"] = (
        portfolio["roe_percentage"]
        .round(2)
    )

    portfolio["roce_percentage"] = (
        portfolio["roce_percentage"]
        .round(2)
    )
